    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <h1 className="text-xl sm:text-2xl font-semibold tracking-tight text-center sm:text-left">
          🚀 Welcome to the <span className="text-blue-600 dark:text-blue-400">DevDanny Template Scaffold</span>
        </h1>

        <ol className="list-inside list-decimal text-sm/6 text-center sm:text-left font-[family-name:var(--font-geist-mono)]">
          <li className="mb-2 tracking-[-.01em]">
            Begin development by editing{" "}
          ...
          <li className="mb-2 tracking-[-.01em]">
            Explore built-in styles, fonts, and layout utilities.
          </li>
          <li className="tracking-[-.01em]">
            Build, customize and deploy your ideas in seconds.
          </li>
        </ol>
